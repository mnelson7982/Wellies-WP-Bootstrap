...
//Remove Menus (To remove More or less Add to Restricted Array Options: Dashboard,Posts,Media,Links,Pages,Appearance,Tools,Users,Settings,Comments, Plugins)
function remove_menus () {
global $menu;
	$restricted = array(__('Links'), __('Tools'),__('Comments'), __('Users'),__('Plugins'));
	end ($menu);
	while (prev($menu)){
