...
function bones_theme_support() {
	...
	register_nav_menus(                      // wp3+ menus
		array( 
			'top_bar_nav' => 'Top Bar Menu',   // main nav in header
...
function bones_main_nav() {
    ...
    wp_nav_menu( 
    	array( 
    		...
    		'container_class' => 'main-nav', /* container class */
    		'fallback_cb' => 'bones_main_nav_fallback', /* menu fallback */
    		'depth' => '1' /* suppress lower levels for now */
    	)
    );
}
function bones_top_bar_nav() { 
	// display the wp3 menu if available
    wp_nav_menu(
    	array(
    		'menu' => 'top_bar_nav', /* menu name */
    		'theme_location' => 'top_bar_nav', /* where in the theme it's assigned */
...
// this is the fallback for footer menu
function bones_top_bar_fallback() { 
	//wp_page_menu( 'show_home=Home&menu_class=menu' ); 
	/* you can put a default here if you like */ 
}
